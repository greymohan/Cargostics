...
const routeOptimizations = [
  {
    id: 'OPT-001', loadId: 'LD-2024-001845', origin: 'Dallas, TX', destination: 'Memphis, TN',
    currentRoute: { distance: '452 mi', time: '7h 30m', fuel: '$285', tolls: '$42' },
    optimizedRoute: { distance: '418 mi', time: '6h 45m', fuel: '$248', tolls: '$18' },
    savings: { distance: '34 mi', time: '45 min', fuel: '$37', total: '$61' },
    confidence: 96, reason: 'Avoids I-30 construction zone and uses I-40 alt route via Little Rock',
  },
  {
    id: 'OPT-002', loadId: 'LD-2024-001847', origin: 'Atlanta, GA', destination: 'Charlotte, NC',
    currentRoute: { distance: '244 mi', time: '4h 15m', fuel: '$154', tolls: '$0' },
    optimizedRoute: { distance: '228 mi', time: '3h 40m', fuel: '$135', tolls: '$0' },
    savings: { distance: '16 mi', time: '35 min', fuel: '$19', total: '$19' },
    confidence: 91, reason: 'Bypasses Greenville congestion via SC-11, faster during peak hours',
  },
  {
    id: 'OPT-003', loadId: 'LD-2024-001849', origin: 'Los Angeles, CA', destination: 'Denver, CO',
    currentRoute: { distance: '1,023 mi', time: '15h 20m', fuel: '$645', tolls: '$0' },
    optimizedRoute: { distance: '988 mi', time: '14h 10m', fuel: '$592', tolls: '$0' },
    savings: { distance: '35 mi', time: '1h 10m', fuel: '$53', total: '$53' },
    confidence: 88, reason: 'Uses I-70 through Glenwood Springs instead of I-25 detour, better elevation profile',
  },
  {
    id: 'OPT-004', loadId: 'LD-2024-001851', origin: 'Seattle, WA', destination: 'Portland, OR',
    currentRoute: { distance: '174 mi', time: '3h 10m', fuel: '$110', tolls: '$12' },
    optimizedRoute: { distance: '168 mi', time: '2h 45m', fuel: '$98', tolls: '$0' },
    savings: { distance: '6 mi', time: '25 min', fuel: '$12', total: '$24' },
    confidence: 94, reason: 'Avoids peak-hour I-5 bottleneck at Tacoma, uses WA-167 corridor',
  },
];
