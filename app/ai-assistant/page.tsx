...
const aiResponses: Record<string, string> = {
  'optimize': "I've analyzed your 24 active routes and found 3 optimization opportunities:\n\n1. **LD-2024-001849** (LA → Denver): Reroute via I-25 instead of I-70 — saves 45 min and $32 in fuel\n2. **LD-2024-001845** (Dallas → Memphis): Suggest rest stop at Little Rock for HOS compliance\n3. **LD-2024-001853** (KC → St. Louis): Can consolidate with LD-2024-001847 return leg\n\nEstimated savings: **$128/day** across all routes.",
